...
namespace ContentHook.API.Controllers
{
    ...
    public class VideosController : ControllerBase
    {
        ...
        public VideosController(IJobRepository jobRepository, IJobQueue jobQueue)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            // TODO: UserId aus JWT-Claim lesen
            const string placeholderUserId = "anonymous";

  
            var job = new Job(placeholderUserId, platform, file.FileName);
